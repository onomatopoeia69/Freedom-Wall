   ...
   <div class="modal fade" id="editpost" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true" wire:ignore.self>
     <div class="modal-dialog">
       <div class="modal-content">
         ...
         <div class="modal-body">
             <form wire:submit='updatePost({{$id}})'>
             <div class="mb-3">
                 <label for="exampleFormControlInput1" class="modal-title text-start w-100">Header</label>
               ...
               <div class="mb-3">
                 <label for="exampleFormControlTextarea1" class="modal-title text-start w-100">Write Something to say</label>
